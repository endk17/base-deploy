...
echo "---------------------------------------------------"
echo -e "\e[32mStep 1: Initializing the script \e[0m" && sleep 2
...
echo "---------------------------------------------------"
echo -e "\e[32mChoose an action. Enter the desired number and confirm with the Enter key\e[0m" && sleep 3
echo -e ""
echo "1 - Install the Base node"
